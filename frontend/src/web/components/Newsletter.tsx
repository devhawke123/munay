export function Newsletter() {
  return (
    <div className="flex flex-col items-center gap-4 bg-gold-deep/[0.06] px-page-x py-section-y text-center sm:gap-6">
      <h2 className="font-futura text-campaign-title text-ink">Subscribe to our Newsletter</h2>
      ...
      >
        ...
        <button
          type="submit"
          className="bg-ink px-8 py-btn-y text-btn uppercase text-white"
        >
          Subscribe
        </button>
      </form>
