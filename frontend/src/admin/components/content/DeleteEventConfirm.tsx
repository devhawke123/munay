...
export function DeleteEventConfirm({ event, onCancel, onConfirm }: DeleteEventConfirmProps) {
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 px-4">
      <div className="w-full max-w-[380px] rounded-[12px] bg-white shadow-card">
        <div className="flex flex-col items-center gap-3 px-6 py-6 text-center">
          ...
          <h2 className="text-base font-display font-bold text-text-primary">Delete this event?</h2>
          <p className="text-sm text-text-muted">
            <strong className="text-text-primary">{event.title}</strong> will be permanently
            removed from the public-facing events page. This can't be undone.
          </p>
        </div>
